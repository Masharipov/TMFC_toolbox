function tmfc_gPPI_GUI_BIG()

    GPPI_GUI = figure("Name", "gPPI", "NumberTitle", "off", "Units", "normalized", "Position", [0.40 0.10 0.22 0.56],'MenuBar', 'none','ToolBar', 'none','color','w','Resize','off');
